...
describe('Sidebar Component', () => {
  ...
  it('should render navigation menu options', async () => {
    ...
    expect(homeLink.getAttribute('href')).toBe('/images/home');
    expect(favoritesLink.getAttribute('href')).toBe('/images/favorites');
  });
  ...
  it('should handle search history key click and navigate to home', async () => {
    ...
    expect(navigateSpy).toHaveBeenCalledWith(['images/home']);
  });
});
